-------------------------------------------------------------------------
---------------ESTADO Y FACTORES ASOCIADOS A ENFERMEDADES---------------
------------NO TRANSMISIBLES EN LOS CONSUMIDORES DEL PERÚ---------------
-------------------------------------------------------------------------

--Autor: Elías Aburto Camacllanqui
--Base de datos: INEI, Endes 2022
--Intrumento: Cuestionario de Salud y del Hogar


--Contexto: Las enfermedades no transmisibles están siendo las principales causas de muerte a nivel mundial.
			--Existen esfuerzos por comprender los factores asociados a estas enfermedades con el objetivo
			--de proponer políticas públicas efectivas que contribuyan a su disminusión.
			
--Problema: ¿Cuál es el estado y los factores asociados a enfermedades no transmisibles en los consumidores del Perú?

--Objetivo: Caracterizar el estado y los factores asociados a enfermedades no transmisibles en los consumidores del Perú

--Público objetivo: Personas mayores de 15 años.


--Pasos Previos
--1. Descargar módulos 1640 y 1629 de la Encuesta Demográfica y de Salud Familiar en formato csv
--2. Cambiar las comas por puntos de las BD CSALUD01 y RECH0. SQL considera los puntos como referentes a decimales, 
		--la coma lo interpreta como una caracter extraño. Cuando descargas la base de datos 
		--del INEI aparece los decimales separados por coma. Modificarlo con block de notas.
...
--copiar información del csv al SQL
copy public.CSALUD01_2022 from 'C:/SamplesSQL/ProyectoSQL-Elías/786-Modulo1640/CSALUD01.csv' delimiter ';' csv header NULL ' '
;



--Recomendaciones
--1. Revisar el tipo de dato de cada variable en el diccionario del INEI. 



--CONSULTAS

--1. Extrae la información (cantidad, porcentaje) de las personas que 
--tienen enfermedades no transmisibles (diabetes, obesidad) en el Perú en el 2022.
...
-- Estamos observando el ID de cada participante 15 a más años que fueron entrevistados
...
--Personas que le midieron el azúcar o glucosa en la sangre
...
-- Cantidad de personas que le diagnósticaron diabetes
...
--Identificar y quitar valores atípicos
...
--Modificamos las comas por puntos en el csv para que pueda leer los decimales.
...
--Cantidad por cada región
SELECT COUNT (*) AS CantidadxRegion
FROM public.rech0_2022
GROUP BY HV024;


--Cantidad por área de residencia (Urbano/rural)
